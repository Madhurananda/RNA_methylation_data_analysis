...
if __name__=='__main__' and '__file__' in globals():
    ...
    # print('Neg array shape: ', neg_array.shape)
    ...
    # print('Neg array shape: ', neg_array.shape)
    # print('Pos array shape: ', pos_array.shape)

    final_array_df_xPore = np.append(neg_array, pos_array[:, 3].reshape(len(pos_array[:, 1]), 1), 1)

    # print('final_array_df_xPore shape: ', final_array_df_xPore.shape)
    ...
    # print('ALL dupl pos: ', len(df_ROC_DRUMMER[df_ROC_DRUMMER.duplicated()]) )
    # print('ALL dupl pos: ', len(df_ROC_xPore[df_ROC_xPore.duplicated()]) )

    # print('ALL dupl pos: ', len(df_ROC_DRUMMER[df_ROC_DRUMMER.duplicated('position')]) )
    # print('ALL dupl pos: ', len(df_ROC_xPore[df_ROC_xPore.duplicated('position')]) )

    # print('ALL dupl pos: ', (df_ROC_DRUMMER[df_ROC_DRUMMER.duplicated('position')]) )
    # print('ALL dupl pos: ', (df_ROC_xPore[df_ROC_xPore.duplicated('position')]) )

    # print('ALL dupl pos: ', (df_ROC_DRUMMER[df_ROC_DRUMMER['position']==22]) )
    # print(df_ROC_DRUMMER[df_ROC_DRUMMER['position'] == '22'])
    # print('ALL dupl pos: ', (df_ROC_xPore[df_ROC_xPore.duplicated('position')]) )
    ...
    # cheui_df = read_outputs(out_files)

    cheui_df = pd.read_csv(out_files[0], delimiter='\t')
