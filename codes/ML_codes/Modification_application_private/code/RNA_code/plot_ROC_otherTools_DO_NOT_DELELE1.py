...
#         if 'A1.complete' in out_files[i] or 'A2.complete' in out_files[i]:
#             # array_out = get_values(out_files[i], ref_content, 'padj')
#             array_out = get_values_tools('DRUMMER', out_files[i], ref_content, 'chr_ctrl', 'pos_ctrl', 'ref_ctrl', 'padj', 0, 0)
#             if array == 0:
#             # if i == 0:
#                 array = array_out
#             else:
...
# def DRUMMER_extract(df__chr, ncld_col_name, a_ncld, pos_diff_val, pos_col_name):
#     ## Get the dataframe for the selected nucleotide 
#     ind_l = []
#     for i in range(len(df__chr)):
#         if df__chr._get_value(i, ncld_col_name) == a_ncld:
#             ind_l.append(i)
#     df__ncld = df__chr.loc[ind_l, :]
...
def get_values_ourtool(result_file, ref_content):
...
if __name__=='__main__' and '__file__' in globals():
    ...
    wt_out_files = [file for file in glob.glob("/home/madhu/work/comp_tools/paper_6/download_tools/DRUMMER/RESULTS/IVT_m6A_0/IVT_m6A_0__isoform/IVT_normalA_fast5_0-IVT_normalA_fast5_1/complete_analysis/*.txt")]
    neg_array = file_content_array(natsorted(wt_out_files))

    ko_out_files = [file for file in glob.glob("/home/madhu/work/comp_tools/paper_6/download_tools/DRUMMER/RESULTS/IVT_m6A_1/IVT_m6A_1__isoform/IVT_normalA_fast5_1-IVT_m6A_fast5/complete_analysis/*.txt")]
    pos_array = file_content_array(natsorted(ko_out_files))
    ...
    col_names = ['chr', 'ref_seq_Nucl', 'position', 'DRUMMER_probs__0', 'DRUMMER_probs__1']
    ...
    # neg_array = get_values_tools('xPore', wt_out_files, ref_content, 'id', 'position', 'kmer', 'pval_ko_vs_wt', 1, 5)
    # pos_array = get_values_tools('xPore', ko_out_files, ref_content, 'id', 'position', 'kmer', 'pval_ko_vs_wt', 1, 5)


    # final_array_df_xPore = np.append(neg_array, pos_array[:, 3].reshape(len(pos_array[:, 1]), 1), 1)
    # col_names = ['chr', 'ref_seq_Nucl', 'position', 'xPore_probs__0', 'xPore_probs__1']
    ...
    # # log_file_name = '/home/madhu/Logs/predict__train_p3_ALL_A_BilstmMean.layers3.hs512.F.lr1000.b256.p1000.GPU.ep1.240093.pt__A.log'
    ...
    # final_array_df_ourtool = get_values_ourtool(log_file_content, ref_gene_content)
    # col_names = ['chr', 'ref_seq_Nucl', 'position', 'OUR_probs__0', 'OUR_probs__1']
    # df_ROC_OUR = pd.DataFrame(final_array_df_ourtool, columns=col_names)
    # print('df_ROC_OUR: ')
    # print( df_ROC_OUR )
    # # print(df_ROC_m6Anet[df_ROC_m6Anet['m6Anet_probs__0'] == '0.2356990426778793'])
    # # print(df_ROC_OUR[df_ROC_OUR['position'] == '186'])

    # save_CSV_file = '/home/madhu/work/comp_tools/paper_6/download_tools/ROC_outputs/roc_info_OUR.csv'
    # df_ROC_OUR.to_csv(save_CSV_file, index=False)
