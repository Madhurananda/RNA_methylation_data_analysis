...
class TS_Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        tf_dataset = tf_data.map(generate_tfrecord_bp.get_feature_from_tfrec)
        ...
        for tf_feat in tf_dataset.take(-1):
            ...
            tf_bp_data.append( tf_feat[bp_features_in_tf].numpy())
        ...
        return (tf_np_data, tf_m_data, tf_len_data, tf_bp_data);
