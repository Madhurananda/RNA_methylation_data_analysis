...
from main import check_endWith, check_create_dir, check_conda_env, write_file, count_lines
...
if __name__=='__main__' and '__file__' in globals():
    ...
    para_dict = {}
    para_dict['save_folder'] = '/home/madhu/work/analysis/p3_m6A_RNA_modification_native_RNA_seq/model_output/';  #      revise
    ...
    try:
        ...
        datafs = [basefolder+'GSM3528750/TFRec_FT/', basefolder+'/GSM3528749/TFRec_FT/']                 #      revise
        ...
        TS_finetune.finetuneTrainer( para_dict = para_dict, datafolders=datafs, is_ft=is_ft_t, ref_seq_file='/mnt/labshare/share/reference_genome/EpiNano_Reference_sequences/cc.fasta',index_file="tfrecord.index", random_seed=3 );          #      revise
