...
def do_TFRec(args):
    ...
    try:
        ...
        if os.path.exists(current_TFRec_dir):
            ...
            TFRec_cmd = 'python /home/madhu/datasets/codes/ML_codes/madhu_codes/generate_tfrecord_ft.py {} {} {} {} "workspace/*/" {} {} {} RNA'.format(current_basecall_folder, current_TFRec_dir, thread, single_mult, BAM_file, len_thr, map_qual_thr)

            print('\n\nTF-Rec FT command: ', TFRec_cmd, '\n\n')
