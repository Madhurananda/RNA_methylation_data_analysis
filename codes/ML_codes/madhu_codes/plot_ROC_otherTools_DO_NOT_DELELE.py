...
def get_values_ourtool(result_file, ref_content):
    ...
    for selected_chr_FINAL in natsorted(selected_chr):
        ...
        for a_part in tqdm(log_file_content.split('\n')):
            if a_part.startswith('Pred: '+selected_chr_FINAL):
                ...
                if len(info_part) == 6:
                    ...
                    # if pos == 17 or pos == 21 or pos == 23:
                    #     print('pos: ', pos)
                    #     print('strand: ', strand)
                    pos_list.append(pos+1)
                    strand_list.append(strand)
                    # if strand == '+':
                        # pos_list_strand_pos.append
        ...
        # print('strand_list:', (strand_list))
        # print('prob_list_0: ', prob_list_0)
        # print('prob_list_1: ', prob_list_1)

        # np.transpose( np.vstack(( np.array([selected_chr_FINAL]*len(pos_list)), np.array(pos_list), np.array(strand_list), np.array(prob_list_0), np.array(prob_list_1) )) )
        ...
        for a_ncld in ncld_list:
            ...
            for i in range(len(df_ourTool['pos'])):
                # df_ourTool._get_value(i, 'strand')
                if (df_ourTool._get_value(i, 'strand') == '+' and a_ncld == 'A') or (df_ourTool._get_value(i, 'strand') == '-' and a_ncld == 'T'):
                # if (df_ourTool['strand'][i] == '+' and a_ncld == 'A') or (df_ourTool['strand'][i] == '-' and a_ncld == 'T'):
                # if selected_chr_seq[pos_list[i]] == a_ncld:
                    # print('FINE')
                    ...
                    # output_pos_list.append(df_ourTool['pos'][i])
                    # output_prob_list_0.append(df_ourTool['prob_list_0'][i])
                    # output_prob_list_1.append(df_ourTool['prob_list_1'][i])
                # else:
                #     print('XXXXXXXXX')
...
if __name__=='__main__' and '__file__' in globals():
    ...
    # # for column in df_ROC:
    # #     print(column)
    # #     if 'probs__0' in column:

    #     # print(df_ROC[column])
    # y_true_ours.extend([0]*len(df_ROC))
    # y_score_ours.extend(df_ROC['OUR_probs__0'])

    # y_true_ours.extend([1]*len(df_ROC))
    # y_score_ours.extend(df_ROC['OUR_probs__1'])
