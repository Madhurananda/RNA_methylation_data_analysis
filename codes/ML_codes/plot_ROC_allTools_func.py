...
def file_content_array(tool_name, out_files, ref_content, chr_col_name, pos_col_name, kmer_col_name, prob_col_name, pos_diff_val, n_mer, if_pVal, CHR_SELECTED, NCLD_SELECTED):
    print('out_files: ', out_files)
    for i in range(len(out_files)):
        array_out = get_values_tools(tool_name, out_files[i], ref_content, chr_col_name, pos_col_name, kmer_col_name, prob_col_name, pos_diff_val, n_mer, if_pVal, CHR_SELECTED, NCLD_SELECTED)
        if array_out != 0:
            if i == 0:
                array = array_out
            else:
...
def check_pos_diff(seq_pos_list, output_pos_list, a_ncld, tool_name, selected_chr_FINAL, pos_values, selected_chr_seq):
    ...
    ####### COMMENT THESE TWO LINES TO SEE THE EXACT POSITION LISTS ########
...
def get_values_tools(tool_name, result_file, ref_content, chr_col_name, pos_col_name, kmer_col_name, prob_col_name, pos_diff_val, n_mer, if_pVal, CHR_SELECTED, NCLD_SELECTED):
...
def get_values_Tombo(tool_name, out_file, ref_content, CHR_SELECTED, NCLD_SELECTED):
...
def get_values_ourtool(tool_name, result_file, ref_content, CHR_SELECTED, NCLD_SELECTED):
...
def get_final_array(tool_name, wt_file, ko_file, ref_content, chr_col_name, pos_col_name, kmer_col_name, prob_col_name, pos_diff_val, n_mer, if_pVal, CHR_SELECTED, NCLD_SELECTED):
    if tool_name == 'Tombo':
        neg_array = get_values_Tombo(tool_name, wt_file[0], ref_content, CHR_SELECTED, NCLD_SELECTED)
        pos_array = get_values_Tombo(tool_name, ko_file[0], ref_content, CHR_SELECTED, NCLD_SELECTED)
    elif tool_name == 'OUR':
        log_file_content = read_file(wt_file)
        # ref_gene_content = read_file(ko_file)
        final_array_df = get_values_ourtool(tool_name, log_file_content, ref_content, CHR_SELECTED, NCLD_SELECTED)
    elif tool_name == 'DRUMMER':
        neg_array = file_content_array(tool_name, natsorted(wt_file), ref_content, chr_col_name, pos_col_name, kmer_col_name, prob_col_name, pos_diff_val, n_mer, if_pVal, CHR_SELECTED, NCLD_SELECTED)
        pos_array = file_content_array(tool_name, natsorted(ko_file), ref_content, chr_col_name, pos_col_name, kmer_col_name, prob_col_name, pos_diff_val, n_mer, if_pVal, CHR_SELECTED, NCLD_SELECTED)
    else:
        neg_array = get_values_tools(tool_name, wt_file, ref_content, chr_col_name, pos_col_name, kmer_col_name, prob_col_name, pos_diff_val, n_mer, if_pVal, CHR_SELECTED, NCLD_SELECTED)
        pos_array = get_values_tools(tool_name, ko_file, ref_content, chr_col_name, pos_col_name, kmer_col_name, prob_col_name, pos_diff_val, n_mer, if_pVal, CHR_SELECTED, NCLD_SELECTED)
...
def get_DRUMMER_files(file_path, CHR_SELECTED):
    DRUMMER_wt = []
