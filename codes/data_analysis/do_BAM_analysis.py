...
from main import check_endWith, check_create_dir, check_env, del_dir_content_files
...
def do_BAM_analysis(args):
    t0 = datetime.now()
    a_dataset, analysis_folder = args[0], args[1]
    ...
    try:
        ...
        # 3rd May, 2023: I realised that the analysis folder also needs to be empty, otherwise the statistics will be wrong. 
        del_dir_content_files(data_analysis_folder)
        ...
        print('a_dataset: ', a_dataset, 'Exception:', e)
        # print('Exception:', e)
...
#           print("       python {} {} {} {}".format(sys.argv[0], "Curlcake_non"))
    ...
    if not type(dataset_list) == list:
        ...
        print('Example: python do_BAM_analysis.py /home/madhu/work/basecall/guppy_v5.0.11/p2_identification_m6A_m5C_RNA_modification [HeLa_all_fast5_M11A_KO, HeLa_all_fast5_M11C_WT, HeLa_all_fast5_M11A_WT, HeLa_all_fast5_M11C_KO] /home/madhu/datasets/analysis/p2_identification_m6A_m5C_RNA_modification /home/madhu/datasets/ref_transcriptome/human/hg38.fa')
        print('Exiting .... ')
        sys.exit(1)
    
    inputs = zip(dataset_list, [analysis_folder]*len(dataset_list))
    ...
    results = tqdm(Pool(n_jobs).imap_unordered(do_BAM_analysis, inputs), total=len(dataset_list))
