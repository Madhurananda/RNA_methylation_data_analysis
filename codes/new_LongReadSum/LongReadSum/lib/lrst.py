...
class Output_BAM(Output_FQ):
    ...
    num_columns = property(_lrst.Output_BAM_num_columns_get, _lrst.Output_BAM_num_columns_set)
    percent_identity = property(_lrst.Output_BAM_percent_identity_get, _lrst.Output_BAM_percent_identity_set)
